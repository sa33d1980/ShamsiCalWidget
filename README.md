...
> **نکته:** ویجت قفل صفحه در گوشی‌های Samsung One UI 5+ و برخی لانچرهای سفارشی قابل استفاده است. روی Pixel و AOSP خالص پشتیبانی نمی‌شود. برای اضافه کردن در قفل صفحه از Good Lock و LockStar استفاده شود.
